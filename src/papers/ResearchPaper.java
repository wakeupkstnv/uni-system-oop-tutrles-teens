...
//		}
//		sb.append("\n");
//		sb.append("Published: ").append(sdf.format(this.published)).append("\n");
...
//	}
	...
	/**
	 * Получает количество цитирований в заданном формате.
	 * @param f Формат вывода цитирований.
	 * @return Строка с количеством цитирований в указанном формате.
	 */
